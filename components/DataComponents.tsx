        ...
        <div className="w-full flex flex-col h-full">
          ...
          {productData.length > 0 && (
            <div className="w-full h-full">
              <div className="w-full h-full py-3 flex items-center justify-between gap-4">
                <div className="dark:bg-stone-950 rounded-sm dark:text-gray-200 w-full h-full flex flex-col items-start justify-center p-4">
                  <p>
                    Name:
                  ...
                  <div className="w-full h-full flex items-start justify-end">
                    <Badge className="bg-stone-900 shadow-md shadow-stone-900 px-2 py-1 dark:text-gray-200 text-sm hover:bg-stone-900">
                      Facture
                    </Badge>
                  </div>
                </div>
                <div className="w-full h-full flex flex-col justify-end lg:w-[500px] items-center gap-2">
                  <div className="w-full h-full flex flex-col items-start justify-between">
                    <p className="text-sm md:text-lg dark:text-gray-200 text-stone-900">
                      Name:
                  ...
                  <div className="w-full lg:w-[500px] h-full py-2 flex items-start justify-start">
                    <div className="w-full h-full flex flex-col items-end justify-end gap-2">
                      <Badge className="bg-stone-950 shadow-md shadow-stone-900 px-2 py-1 dark:text-gray-200 text-lg hover:bg-stone-900">
