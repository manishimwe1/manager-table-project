...
const Sidebar = () => {
  ...
  return (
    <div className="space-y-3 md:w-40 mt-4 overflow-y-hidden sticky top-0 hidden lg:flex ">
          ...
          {navLink.map((link) => {
            ...
            return (
              <Link
                ...
                href={link.route}
                className={cn(
                  "flex gap-1 w-full items-center px-2 py-2 shadow-sm shadow-black/50 rounded-2xl ",
                  isActive &&
